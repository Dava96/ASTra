...
def test_index_files(resolver):
    nodes = [
        ASTNode(id="n1", type="module", name="mod1", file_path="astra/core/orchestrator.py", content="", start_line=1, end_line=1, language="python"),
        ASTNode(id="n2", type="module", name="mod2", file_path="astra/ingestion/pipeline.py", content="", start_line=1, end_line=1, language="python"),
    ]
...
def test_resolve_absolute_imports(resolver):
    nodes = [
        ASTNode(id="n1", type="module", name="mod1", file_path="source.py", content="", start_line=1, end_line=1, language="python"),
        ASTNode(id="n2", type="module", name="mod2", file_path="target.py", content="", start_line=1, end_line=1, language="python"),
        ASTNode(id="n3", type="import_statement", name="import", file_path="source.py", content="import target", start_line=1, end_line=1, language="python"),
    ]
...
def test_resolve_from_imports(resolver):
    target_node = ASTNode(id="n2", type="module", name="orchestrator", file_path="astra/core/orchestrator.py", content="", start_line=1, end_line=1, language="python")
    source_node = ASTNode(
        id="n1",
...
def test_resolve_relative_imports(resolver):
    ...
    target_node = ASTNode(id="n2", type="module", name="parser", file_path="astra/ingestion/parser.py", content="", start_line=1, end_line=1, language="python")
    source_node = ASTNode(
        id="n1",
        type="import_from_statement",
        name="import",
